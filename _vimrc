...
" 2. File compatibility and configuration issues
    ...
    set shiftwidth=4 " shiftwidth - how many columns should the text be indented
    ...
    highlight CursorLine   cterm=NONE ctermbg=NONE ctermfg=NONE guibg=green guifg=NONE
    set cursorline
